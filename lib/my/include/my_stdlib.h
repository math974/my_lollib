...
//               |___/_____|
//
//    The library <my_stdlib.h> (for MY standard library) offers
//    functions to answer different problems.
//    First of all, this library will allow you to manage memory dynamically,
//    by allocating or freeing memory in the heap.
//    It will also allow you to interact with the operating system
//    on which the program runs.
//    This library also offers a number of other utility functions
//    for conversions between data types,
//    algorithms (sorting, dichotomous search,
...
////////////////////////////////////////////////////////////
/// \brief If all goes well, the function returns a pointer to the
...
/// \param nbr the value for which the absolute value must be calculated.
///
/// \return returns the absolute value of the very long integer
/// proposed in parameter.
///
////////////////////////////////////////////////////////////
...
///
/// \param str this parameter contains the string of characters to be
/// converted into a data of type int.
///
/// \return If the string to be converted does not contain
/// an integer numeric data, the value 0 will be returned.
/// Otherwise, a value of type int equivalent to the string
/// passed as parameter will be returned.
///
////////////////////////////////////////////////////////////
...
///
/// \param str This parameter contains the string to be converted
/// to a long data type.
///
...
///
/// \param str This parameter contains the string to be converted
/// into a long long (or long long int) data type.
///
/// \return If the string to be converted does not contain an integer data,
...
////////////////////////////////////////////////////////////
/// \brief This function transforms a character string,
/// representing a floating value, into a numerical value of type double
///
/// \param str This parameter contains the string to be converted
/// to a double data type.
///
/// \return If the string to be converted does not contain
/// a floating-point numeric data,
/// the value 0 will be returned. Otherwise, a value of type double equivalent
/// to the string passed in parameter will be returned.
///
////////////////////////////////////////////////////////////
...
/// This means that if the free memory space following the block
/// to be reallocated is large enough, the memory block is simply enlarged.
/// On the other hand, if the free space is not sufficient,
/// a new block of memory will be allocated,
/// the contents of the original area will be copied
/// into the new area and the original block of memory
...
///
/// \param mem_size allows you to specify the size (in bytes)
/// of the memory block to be allocated.
///
/// \return If all goes well, the function returns a pointer
/// to the reallocated memory area.
/// Be careful, this pointer is a generic pointer (void *): if necessary,
/// it is your responsibility
/// to "cast" your pointer to another type
/// (at least if you don't want to have a warning displayed
/// by the compiler, which I strongly recommend).
/// In the event that the memory block cannot be reallocated
/// to you (no more memory available, for example),
/// the NULL pointer will be returned.
/// One should normally and systematically
/// test that the function does not return this value.
...
////////////////////////////////////////////////////////////
/// \brief This function allocates a block of memory
/// by initializing all these bytes to the value 0.
///
...
///
/// \return If all goes well, the function returns a pointer
/// to the newly allocated area.
/// Be careful, this pointer is of the generic pointer type (void *):
/// if necessary, it is your responsibility to "cast"
/// your pointer to another type
/// (at least if you do not want to have a warning displayed by the compiler,
